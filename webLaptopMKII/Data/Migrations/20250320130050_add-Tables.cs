    ...
    public partial class addTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartDetails_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableDetail", x => x.OrderDetailId);
                    table.ForeignKey(
                        name: "FK_TableDetail_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TableDetail_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableDetail_ItemId",
                table: "TableDetail",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_TableDetail_OrderId",
                table: "TableDetail",
                column: "OrderId");
        }
